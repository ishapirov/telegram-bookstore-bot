...
@Component
public class BackABookInCatalogCommand implements Command {
    @Autowired
    BookCatalogController bookCatalogController;

    private final ButtonAction actionWhichTriggersCommand = ButtonAction.BACK_A_BOOK_IN_CATALOG;
    ...
    public Object execute(UserCallbackRequest userCallbackRequest) {
        ...
        return bookCatalogController.backABook(catalogControllerData);
    }
