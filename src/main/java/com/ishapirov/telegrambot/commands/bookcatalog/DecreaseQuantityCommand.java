...
public class DecreaseQuantityCommand implements Command {
    ...
    private final ButtonAction actionWhichTriggersCommand = ButtonAction.DECREASE_QUANTITY;
    ...
    public Object execute(UserCallbackRequest userCallbackRequest) {
        ...
        return bookCatalogController.decreaseQuantity(catalogControllerData);
    }
