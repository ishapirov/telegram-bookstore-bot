...
@Component
public class ForwardABookInCartCommand implements Command {
    @Autowired
    ViewAndEditBooksInCartController viewAndEditBooksInCartController;

    private final ButtonAction actionWhichTriggersCommand = ButtonAction.FORWARD_A_BOOK_IN_CART;
    ...
    public Object execute(UserCallbackRequest userCallbackRequest) {
        ...
        return viewAndEditBooksInCartController.forwardABook(viewAndEditBooksControllerInfo);
    }
