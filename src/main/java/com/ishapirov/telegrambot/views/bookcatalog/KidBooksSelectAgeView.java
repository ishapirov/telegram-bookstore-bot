...
public class KidBooksSelectAgeView implements TelegramView {
    ...
    protected InlineKeyboardMarkup generateKeyboard(String locale) {
        ...
        InlineKeyboardButton buttonSixMonth = new InlineKeyboardButton().setText(localeMessageService.getMessage("view.kidselect.sixmonth",locale));
        ...
        InlineKeyboardButton buttonOneToThree = new InlineKeyboardButton().setText(localeMessageService.getMessage("view.kidselect.onetothree",locale));
        ...
        InlineKeyboardButton buttonThreeToFive= new InlineKeyboardButton().setText(localeMessageService.getMessage("view.kidselect.threetofive",locale));
        ...
        InlineKeyboardButton buttonFiveToSeven= new InlineKeyboardButton().setText(localeMessageService.getMessage("view.kidselect.fivetoseven",locale));
        ...
        InlineKeyboardButton buttonAll = new InlineKeyboardButton().setText(localeMessageService.getMessage("view.kidselect.all",locale));
    ...
    protected String generateText(String locale) {
        return localeMessageService.getMessage("view.kidselect.generate",locale);
    }
